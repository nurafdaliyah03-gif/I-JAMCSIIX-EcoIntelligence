...
# --- 3. FUNGSI NORMALISASI PROVINSI (FIX PETA) ---
...
if st.session_state.page == "Portal":
    ...
    st.info("Algoritma MERF sedang diproses...")
    ...
    with rc1:
        ...
        st.markdown("<div class='research-card'><h4>📊 Sumber Data</h4><ul><li>BPS: Data sosio-ekonomi agregat.</li><li>KLHK: Rekapitulasi Karhutla.</li><li>Global Forest Watch: Tree Cover Loss.</li></ul></div>", unsafe_allow_html=True)
    with rc2:
        ...
        st.markdown("<p><b>Keterangan:</b><br>• y_i: Respon Tree Cover Loss.<br>• f(X_i): Fixed effects Random Forest.<br>• Z_i: Matriks desain random effects.<br>• b_i: Vektor penyimpangan acak.<br>• \varepsilon_i: Error residual.</p></div>", unsafe_allow_html=True)
    
    st.markdown("""<div style='background: #450a0a; padding: 20px; border-radius: 10px;'><h5>⚠️ Batasan Penelitian</h5>
    <ul><li>Ketergantungan Data Historis: Tidak membaca perubahan mendadak.</li>
    <li>Optimal Jangka Pendek: Rentan akumulasi error jangka panjang.</li>
    <li>Efek Wilayah Baru: Mengabaikan efek acak (b_i=0).</li>
