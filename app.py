...
if st.session_state.page == "Portal":
    ...
    if st.session_state.page == "Dashboard":
        ...
        with cl:
            if geojson:
                fig = px.choropleth(df_filt_year, geojson=geojson, locations="PROVINSI", featureidkey="properties.PROV_KEY", color=col_y, color_continuous_scale="RdYlGn_r")
                fig.update_geos(fitbounds="locations" if sel_prov != "Semua Provinsi" else False, visible=False)
                if sel_prov != "Semua Provinsi": fig.update_geos(fitbounds="locations")
        ...
        st.markdown("<h3 style='color: #facc15; font-weight: bold;'>🌍 ESTIMASI RISIKO</h3>", unsafe_allow_html=True)
        df = st.session_state.df
        prov_target = st.selectbox("Pilih Wilayah:", sorted(df['PROVINSI'].unique()))
        ...
        with rc2:
            ...
            with st.container():
                ...
                <p style='font-size: 0.85rem; color: #cbd5e1; margin-top: 10px; line-height: 1.4;'>
                    ...
                    <b>Keterangan fungsi dan simbol:</b><br>
            ...
            <div class='research-card'>
                ...
                <table style='width: 100%; border-collapse: collapse; color: #f8fafc;'>
                    ...
                    <tr style='border-bottom: 2px solid #15803d; color: #facc15;'>
                        ...
                        <th style='padding: 8px; text-align: left;'>Nama Variabel</th>
                    ...
                    <tr><td style='padding: 8px; font-weight: bold; color: #fbbf24;'>Y</td><td style='padding: 8px;'>Tree Cover Loss</td><td style='padding: 8px;'>Ha</td></tr>



                    <tr><td style='padding: 8px; font-weight: bold; color: #22c55e;'>X1</td><td style='padding: 8px;'>Luas Penutupan Lahan</td><td style='padding: 8px;'>Ribu Ha</td></tr>



                    <tr><td style='padding: 8px; font-weight: bold; color: #22c55e;'>X2</td><td style='padding: 8px;'>Luas Karhutla</td><td style='padding: 8px;'>Ha</td></tr>



                    <tr><td style='padding: 8px; font-weight: bold; color: #22c55e;'>X3</td><td style='padding: 8px;'>Luas Perkebunan</td><td style='padding: 8px;'>Ribu Ha</td></tr>
        ...
        with v_col2:
            ...
            <div class='research-card'>
                ...
                <table style='width: 100%; border-collapse: collapse; color: #f8fafc;'>
                    ...
                    <tr><td style='padding: 8px; font-weight: bold; color: #22c55e;'>X4</td><td style='padding: 8px;'>Kepadatan Penduduk</td><td style='padding: 8px;'>Jiwa/km²</td></tr>



                    <tr><td style='padding: 8px; font-weight: bold; color: #22c55e;'>X5</td><td style='padding: 8px;'>Populasi Ternak</td><td style='padding: 8px;'>Ekor</td></tr>



                    <tr><td style='padding: 8px; font-weight: bold; color: #22c55e;'>X6</td><td style='padding: 8px;'>PDRB Pertambangan</td><td style='padding: 8px;'>Persen (%)</td></tr>
        ...
        <div style='background: linear-gradient(135deg, #7f1d1d 0%, #450a0a 100%); padding: 25px; border-radius: 15px; border: 1px solid #ef4444; margin-top: 10px;'>
            ...
            <ul style='margin: 0; padding-left: 20px; font-size: 0.9rem; color: #ffeeee; text-align: justify; line-height: 1.6; list-style-type: disc;'>
                ...
                <li><b>Optimal Jangka Pendek:</b> Estimasi paling akurat untuk masa depan terdekat. Prediksi terlalu jauh ke depan berisiko memperbesar akumulasi kesalahan (<i>error propagation</i>).</li>
                ...
                <li><b>Cakupan Variabel Makro:</b> Model menggunakan data agregat tahunan (skala provinsi), sehingga belum mencakup faktor mikro lokal seperti konflik lahan atau izin konsesi korporasi.</li>



                <li><b>Resolusi Spasial Makro:</b> Tidak memperhitungkan faktor pemicu eksternal mendadak (exogenous shocks) di luar variabel terdata.</li>
