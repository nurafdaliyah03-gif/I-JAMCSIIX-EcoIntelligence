...
<style>
    ...
    .menu-card { 
        ...
        border: 1px solid rgba(250, 204, 21, 0.3); border-radius: 30px; 
        padding: 40px; text-align: center; height: 350px; transition: 0.3s;
    }
    ...
    div.stButton > button { 
        ...
        border: 1px solid #facc15 !important; border-radius: 10px; font-weight: bold;
    }
    .research-card { 
        background: rgba(30, 41, 59, 0.7); border: 1px solid rgba(250, 204, 21, 0.2); 
...
if st.session_state.page == "Portal":
    ...
    if st.session_state.page == "Dashboard":
        ...
        st.markdown("<h3 style='color: #facc15;'>🌍 ESTIMASI RISIKO</h3>", unsafe_allow_html=True)
        df = st.session_state.df
